...
namespace CRM.Core
{
    public class tbl_Dictionary
    {
        ...
        public virtual ICollection<tbl_CustomerLeague> tbl_CustomerLeagueCardLevel { get; set; }
        public virtual ICollection<tbl_CustomerLeague> tbl_CustomerLeagueAirline { get; set; }
        ...
        public virtual ICollection<tbl_Staff> tbl_StaffContractType { get; set; }
        ...
        public virtual ICollection<tbl_Ticket> tbl_TicketCardLevel { get; set; }
        public virtual ICollection<tbl_Ticket> tbl_TicketAirlineLeague { get; set; }

        public virtual ICollection<tbl_Candidate> tbl_CandidateNameType { get; set; }
        public virtual ICollection<tbl_Candidate> tbl_CandidateNational { get; set; }
        public virtual ICollection<tbl_Candidate> tbl_CandidateRelegion { get; set; }
        
        public virtual ICollection<tbl_ReceiptBill> tbl_ReceiptBillCurrency { get; set; }
        public virtual ICollection<tbl_ReceiptBill> tbl_ReceiptBillStatus { get; set; }
        public virtual ICollection<tbl_ReceiptBillPeriod> tbl_ReceiptBillPeriod { get; set; }

        public virtual ICollection<tbl_PaymentBill> tbl_PaymentBillStatus { get; set; }
        public virtual ICollection<tbl_PaymentBill> tbl_PaymentBillCurrency { get; set; }
        public virtual ICollection<tbl_PaymentBillPeriod> tbl_PaymentBillPeriod { get; set; }

        public virtual ICollection<tbl_POApproval> tbl_POApprovalPaymentMethod { get; set; }
        public virtual ICollection<tbl_POApproval> tbl_POApprovalCurrency { get; set; }
        public virtual ICollection<tbl_POApproval> tbl_POApprovalStatus { get; set; }
        public virtual ICollection<tbl_POApprovalPermission> tbl_POApprovalPermission { get; set; }
