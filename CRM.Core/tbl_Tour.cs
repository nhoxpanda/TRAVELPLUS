...
namespace CRM.Core
{
    public class tbl_Tour
    {
        ...
        public Nullable<DateTime> BiddingDate { get; set; }
        public Nullable<DateTime> BiddingResultDate { get; set; }
        ...
        public virtual tbl_Quotation tbl_Quotation { get; set; }
        [ForeignKey("StaffId")]
        ...
        public virtual ICollection<tbl_TourNote> tbl_TourNote { get; set; }
