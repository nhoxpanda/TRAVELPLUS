    ...
    public class PartnerManageController : BaseController
    {
        ...
        public ActionResult _Partial_ListPartner()
        {
            ...
            var model = _partnerRepository.GetAllAsQueryable().AsEnumerable().Where(p => (p.StaffId == maNV | maNV == 0)
                    ...
                    .Select(p => new PartnerViewModel
                    {
                        ...
                        Province = p.tbl_TagsProvince == null ? "" : p.tbl_TagsProvince.Tag,
                        Email = p.Email,
                        Id = p.Id,
                        Name = p.Name,
                        Phone = p.Phone,
                        ...
                        BussinessLicense = p.BusinessLicense
                    });
        ...
        public ActionResult ExcelSample()
        {
            try
            {
                ...
                {
                    string templateFile = System.Web.HttpContext.Current.Server.MapPath("~\\Upload\\ImportExport\\Import_DoiTacTRAVELPLUS.xlsx");
