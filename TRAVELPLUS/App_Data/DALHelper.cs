...
namespace TRAVELPLUS.App_Data
{
    public static class DALHelper
    {
        private static IDbConnection _db = new SqlConnection("Data Source=103.27.239.106;Initial Catalog=Web_TRAVELPLUS;user id=Web_TRAVELPLUS_login;password=SIKU%$^#HJGF;Integrated Security=false;MultipleActiveResultSets=True");
