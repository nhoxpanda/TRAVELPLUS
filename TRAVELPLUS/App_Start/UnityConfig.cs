...
using TRAVELPLUS.Controllers;
using CRM.Core;

namespace TRAVELPLUS.App_Start
{
    /// <summary>
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IGenericRepository<tbl_StaffSalary>, GenericRepository<tbl_StaffSalary>>();
            container.RegisterType<IGenericRepository<tbl_POApproval>, GenericRepository<tbl_POApproval>>();
            container.RegisterType<IGenericRepository<tbl_POApprovalDetail>, GenericRepository<tbl_POApprovalDetail>>();
            container.RegisterType<IGenericRepository<tbl_POApprovalHistory>, GenericRepository<tbl_POApprovalHistory>>();
            container.RegisterType<IGenericRepository<tbl_POApprovalPermission>, GenericRepository<tbl_POApprovalPermission>>();
            container.RegisterType<IGenericRepository<tbl_Airport>, GenericRepository<tbl_Airport>>();
            container.RegisterType<IGenericRepository<tbl_CustomerLeague>, GenericRepository<tbl_CustomerLeague>>();
            container.RegisterType<IGenericRepository<tbl_TourCalculation>, GenericRepository<tbl_TourCalculation>>();
